  ...
  {miniCardsData.usersThisMonth.length > 0 && miniCardsData.usersLastMonth.length > 0 ? (
    ...
    <span className="text-warning text-sm font-weight-bolder">
     &nbsp;&nbsp; Sin datos suficientes para comparar
                ...
                {/* Fin Clientes este mes  */}
              </div>
              <div className="col-4 text-end">
                <div className="icon icon-shape bg-gradient-success shadow-success text-center rounded-circle">
                <i className="fas fa-thumbs-up text-lg opacity-10" aria-hidden="true" />
          ...
          <div className="card-body p-3">
            <div className="row">
              ...
              <div className="col-4 text-end">
                ...
                <i className="fas fa-user-friends text-lg opacity-10" aria-hidden="true"/>
                </div>
              </div>
            </div>
          </div>
